...
graph_dir=/global/cscratch1/sd/andrish/training_data/graphs_4/HomHLV
...
# can be done by using --signal 1 or --signal 3.
...
train_gnn config homo_encoder.yaml
...
model_dir=/global/cscratch1/sd/andrish/training_data/homo_encoder
test_dir=/global/cfs/cdirs/m3443/data/TauStudies/v5
config_name=homo_encoder
